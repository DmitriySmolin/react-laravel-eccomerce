...
class ProductCartController extends Controller
{
    ...
    public function PendingOrder()
    {
        ...
        $orders = CartOrder::where('order_status', 'В ожидании')->orderBy('id', 'DESC')->get();
    ...
    public function ProcessingOrder()
    {
        ...
        $orders = CartOrder::where('order_status', 'В обработке')->orderBy('id', 'DESC')->get();
    ...
    public function CompleteOrder()
    {
        ...
        $orders = CartOrder::where('order_status', 'Завершен')->orderBy('id', 'DESC')->get();
    ...
    public function PendingToProcessing($id)
    {
        ...
        CartOrder::findOrFail($id)->update(['order_status' => 'В обработке']);
    ...
    public function ProcessingToComplete($id)
    {
        ...
        CartOrder::findOrFail($id)->update(['order_status' => 'Завершен']);
