...
class CategoryController extends Controller
{
    ...
    public function StoreCategory(Request $request)
    {
        ...
        $request->validate([
            ...
            'category_name.required' => 'Введите имя категории'
    ...
    public function UpdateCategory(Request $request)
    {
        ...
        if ($request->file('category_image')) {
            ...
            $notification = array(
                'message' => 'Обновление категории с изображением успешно',
                'alert-type' => 'success'
            );
            ...
            $notification = array(
                'message' => 'Категория успешно обновлена без изображения',
                'alert-type' => 'success'
            );
    ...
    public function StoreSubCategory(Request $request)
    {
        ...
        $request->validate([
            ...
            'subcategory_name.required' => 'Введите имя  подкатегории'
