                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="border border-3 p-4 rounded">
                                        <div class="mb-3">
                                            <label for="inputProductTitle" class="form-label">Заголовок товара</label>
                                            <input type="text" name="title" class="form-control" id="inputProductTitle"
                                                   placeholder="Введите заголовок товара">
                                        </div>
                                        <div class="mb-3">
                                            <label for="inputProductTitle" class="form-label">Код товара</label>
                                            <input type="text" name="product_code" class="form-control"
                                                   id="inputProductTitle" placeholder="Введите код товара">
                                        </div>
                                        <div class="mb-3">
                                            <label for="formFile" class="form-label">Миниатюра товара </label>
                                            ...
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">Первое изображение</label>
                                                <input class="form-control" name="image_one" type="file">
                                            </div>
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">Второе изображение</label>
                                                <input class="form-control" name="image_two" type="file">
                                            </div>
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">Третье изображение</label>
                                                <input class="form-control" name="image_three" type="file">
                                            </div>
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">Четвертое изображение</label>
                                                <input class="form-control" name="image_four" type="file">
                                            </div>
                                            <div class="mb-3">
                                                <label for="inputProductDescription" class="form-label">Краткое
                                                    описание</label>
                                                <textarea name="short_description" class="form-control"
                                                          id="inputProductDescription" rows="3"></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label for="inputProductDescription" class="form-label">Подробное
                                                    описание</label>
                                                <textarea id="mytextarea"
                                                          name="long_description">Hello, World!</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 mt-2">
                                        <div class="border border-3 p-4 rounded">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="inputCompareatprice" class="form-label">Специальная цена</label>
                                                    <input type="text" name="special_price" class="form-control"
                                                           id="inputCompareatprice" placeholder="00.00">
                                                </div>
                                                <div class="col-12">
                                                    <label for="inputProductType" class="form-label">Категория товара</label>
                                                ...
                                                <div class="col-12">
                                                    <label for="inputProductType" class="form-label">Подкатегория товара</label>
                                                    <select name="subcategory" class="form-select"
                                                            id="inputProductType">
                                                        <option selected="">Выбрать подкатегорию</option>
                                                        @foreach($subcategory as $item)
                                                            <option
                                                                value="{{ $item->subcategory_name }}"> {{ $item->subcategory_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-12">
                                                    <label for="inputCollection" class="form-label">Бренд </label>
                                                ...
                                                <div class="col-12">
                                                    <div class="d-grid">
                                                        <button type="submit" class="btn btn-primary">Сохранить товар
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
