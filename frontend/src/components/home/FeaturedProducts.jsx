        ...
        return <Col className="p-1" key={1} xl={2} lg={2} md={2} sm={4} xs={6}>
          <Link className="text-link" to={"/productdetails/" + FeaturedList.id}>
            <Card className="image-box card">
              <img className="center" src={FeaturedList.image} alt="img"/>
              <Card.Body>
                <p className="product-name-on-card">{FeaturedList.title}</p>
                <p className="product-price-on-card">Цена : {FeaturedList.price}₽</p>
              </Card.Body>
            </Card>
          </Link>
        </Col>;
      ...
      <Fragment>
        ...
        <div className={this.state.mainDiv}>
          <Container className="text-center" fluid={true}>
            <div className="section-title text-center mb-55"><h2>РЕКОМЕНДУЕМЫЕ ТОВАРЫ</h2>
              <p>Товары из нашей коллекции, которые могут вам понравиться</p>
            </div>
            <Row>
              {MyView}
            </Row>
