                ...
                <Row>
                    <Col className="p-0" xl={3} lg={3} md={3} sm={6} xs={6}>
                        <Card className="image-box card w-100">
                            ...
                            <Card.Body>
                                <p className="product-name-on-card">Красная мужская худи c копюшоном в полоску</p>
                                <p className="product-price-on-card">Price: 7350₽</p>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col className="p-0" xl={3} lg={3} md={3} sm={6} xs={6}>
                        <Card className="image-box card w-100">
                            ...
                            <Card.Body>
                                <p className="product-name-on-card">Мужская футболка с круглым вырезом</p>
                                <p className="product-price-on-card">Price: 7350₽</p>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col className="p-0" xl={3} lg={3} md={3} sm={6} xs={6}>
                        <Card className="image-box card w-100">
                            ...
                            <Card.Body>
                                <p className="product-name-on-card">Мужская серая худи с круглым вырезом</p>
                                <p className="product-price-on-card">Price: 7350₽</p>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col className="p-0" xl={3} lg={3} md={3} sm={6} xs={6}>
                        <Card className="image-box card w-100">
                            ...
                            <Card.Body>
                                <p className="product-name-on-card">Мужская красная худи с капюшоном и принтом</p>
                                <p className="product-price-on-card">Price: 7350₽</p>
                            </Card.Body>
                        </Card>
                    </Col>
