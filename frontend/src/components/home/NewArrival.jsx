          ...
          <Link className="text-link" to={"/productdetails/" + NewList.id}>
            <Card className="image-box card">
              ...
              <Card.Body>
                ...
                <p className="product-price-on-card">Цена : {NewList.price}₽</p>
              </Card.Body>
            </Card>
          </Link>
        </div>;
            ...
            <Card className="image-box card">
              ...
              <Card.Body>
                ...
                <p className="product-price-on-card">Цена : <strike
                  className="text-secondary">{NewList.price}₽</strike> {NewList.special_price}₽</p>
              </Card.Body>
            </Card>
          </Link>
        </div>;
      ...
      <Fragment>
        ...
        <div className={this.state.mainDiv}>
          <Container className="text-center" fluid={true}>
            <div className="section-title text-center mb-55"><h2>НОВАЯ КОЛЛЕЦИЯ &nbsp;
