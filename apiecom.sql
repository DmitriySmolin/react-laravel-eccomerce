...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=342226373ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Недавние таблицы" class="drop_button btn">Недавнее</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=apiecom&table=contacts">`apiecom`.`contacts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=apiecom&table=users">`apiecom`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=apiecom&table=categories">`apiecom`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=apiecom&table=product_carts">`apiecom`.`product_carts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=apiecom&table=cart_orders">`apiecom`.`cart_orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=apiecom&table=product_lists">`apiecom`.`product_lists`</a></li></ul></div><div class="drop_list"><button title="Избранные таблицы" class="drop_button btn">Избранное</button><ul id="pma_favorite_list"><li class="warp_link">Нет избранных таблиц.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="23793f6b4451564a4e67285d5a2a765e">
